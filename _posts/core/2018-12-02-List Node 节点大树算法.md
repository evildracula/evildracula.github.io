...
public class Solution {
    ...
    public static ListNode addNext(ListNode n1, ListNode n2, ListNode p1,
        ...
        if (n1 == null && n2 == null) {
            ...
            // at least 1 null
            ListNode t = addNext(n1 == null ? null : n1.next, n2 == null ?
                    null : n2.next, n1, n2);
            t = t == null ? (n1 == null ? n2 : n1) : t;
            l.add(t);
            return t;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        ListNode rs = addTwoNumbers(n1, n11);
